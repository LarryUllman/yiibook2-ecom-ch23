CREATE SCHEMA IF NOT EXISTS `yiibook2_ch23` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `yiibook2_ch23` ;

-- -----------------------------------------------------
-- Table `yiibook2_ch23`.`book`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `yiibook2_ch23`.`cart_content`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yiibook2_ch23`.`cart_content` (
  ...
  CONSTRAINT `fk_cart_content`
    FOREIGN KEY (`cart_id`)
    REFERENCES `yiibook2_ch23`.`cart` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  INDEX `fk_cart_books_idx` (`book_id` ASC),
  CONSTRAINT `fk_cart_books`
    FOREIGN KEY (`book_id`)
    REFERENCES `yiibook2_ch23`.`book` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `yiibook2_ch23`.`order_content`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yiibook2_ch23`.`order_content` (
  ...
  CONSTRAINT `fk_order_content_order1`
    ...
    REFERENCES `yiibook2_ch23`.`order` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `yiibook2_ch23`.`download`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yiibook2_ch23`.`download` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `customer_id` INT UNSIGNED NOT NULL,
  `book_id` INT UNSIGNED NOT NULL,
  `date_entered` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- -----------------------------------------------------
-- Table `yiibook2_ch23`.`password_token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `yiibook2_ch23`.`password_token` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `customer_id` INT UNSIGNED NOT NULL,
